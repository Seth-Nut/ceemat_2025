...
4.  Explicar menos, [mostrar más.]{style="background-color:black;"} 
:::
...
## Mejores gráficos para sus datos{background-image="images/background.jpg" background-opacity="0.25"}
...
Tu primera versión [**siempre** será horrible.]{.fragment} 
:::
:::
...
[Explicar menos]{style="color: red"} y [mostrar más.]{.fragment style="color: green"}  
:::
:::
...
plt.title('😊 ¿Te está gustando la presentación hasta ahora? 😊')
...
4.  Explicar menos, [mostrar más.]{.fragment style="color:grey;"}
:::
...
## 🎊 ¡Bien hecho! Terminaste el curso 🎊 {background-image="images/background.jpg" background-opacity="0.25"}

![](images/sethnut5.png){fig-align="center" width="60%"}
