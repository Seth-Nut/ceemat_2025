...
-   **Cantidad de sesiones a realizar:** de 2 a 4 sesiones de 1 hora
...
¡Perfecto! 🚀
Podemos agregar una sección clara de **Instrucciones del Curso** justo después de *Prerrequisitos*. Algo así:


## Instrucciones

Para comenzar con el mini curso y aprovechar al máximo las actividades, sigue estos pasos:

1. **Crear una cuenta en GitHub**  
   Si aún no tienes una, regístrate en [https://github.com](https://github.com).  

2. **Usar el repositorio del curso como plantilla**  
   Ingresa a [ceemat-entregables](https://github.com/fralfaro/ceemat-entregables) y haz clic en **"Use this template"** para crear tu propio repositorio.  

3. **Subir tus entregables**  
   Coloca directamente tus archivos en la carpeta `entregables/` de tu repositorio.  

4. **Apoyar proyectos relacionados**  
   Da ⭐ *star* a los siguientes repositorios:  
   - [MAT281](https://github.com/fralfaro/MAT281)  
   - [CEEMAT 2025](https://github.com/Seth-Nut/ceemat_2025)  
...
-   🎤 [**Prompts Perfectos en ChatGPT**](prompts_chatgpt/presentacion.html) - Diseña preguntas y comandos efectivos para interactuar con IA como ChatGPT. Aprende a crear prompts que resuelvan problemas, generen ideas y mejoren tus resultados de forma precisa y ética.
...
-   🎤 [**No es Magia, es Ciencia - Cómo conversar mejor con asistentes de IA**](https://sethnut.com/talks/prompts_chatgpt/presentacion_ceemat.html#/title-slide) - Diseña preguntas y comandos efectivos para interactuar con IA como ChatGPT. Aprende a crear prompts que resuelvan problemas, generen ideas y mejoren tus resultados de forma precisa y ética.


-   🎤 [**Crea, Innova y Presenta - Data Storytelling + A.I.**](https://sethnut.com/talks/shiny_2025/presentacion_ceemat.html#/hello-quarto-title) - Esta presentación te enseñará a transformar datos en historias visuales interactivas usando A.I y otras herramientas. Descubre cómo crear presentaciones dinámicas e impactantes que cautiven a tu audiencia.
...
- [CEEMAT 2025 - 2° Semestre](diplomas/diplomas2.html)